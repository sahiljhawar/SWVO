...
#docker run -v $INPUT_DIR:$INPUT_DIR --name $CONTAINER_NAME  $IMAGE /bin/bash -c "$PYTHON /data_management/scripts/plot/wp2/plot_all_swift.py -logdir $TEMP_LOG_DIR -output $TEMP_RESULTS_DIR -date 20210622"
