...
class OMNIHighRes(object):
    ...
    HEADER = ["year", "day", "hour", "minute", "id_imf", "id_sw", "%points_imfavg", "%points_plasmaavg",
              "%interp", "timeshift", "rms_timeshift", "rms_phase_front",
              "time_btwn_observation", "bavg", "bx_gse_gsm", "by_gse", "bz_gse", "by_gsm", "bz_gsm",
              "rms_sd_scalar", "rms_sd_vector", "speed", "vx_gse", "vy_gse", "vz_gse", "proton_density",
              "temperature", "flow_pressure", "e", "plasma_beta", "alfven_mach_n",
              "x_gse", "y_gse", "z_gse", "bsn_x", "bsn_y", "bsn_z", "ae", "al", "au", "sym_d", "sym_h",
              "asy_d", "asy_h", "pc", "magnetosonic_mach_n", "p_flux_10", "p_flux_30", "p_flux_60"]
    ...
    def download_and_process(self, start_time:datetime, end_time:datetime, cadence_min:float=1, reprocess_files:bool=False, verbose:bool=False):
    ...
    def _process_single_file(self, file_path):
        ...
        to_drop = ["year", "day", "hour", "minute", "id_imf", "id_sw", "%points_imfavg", "%points_plasmaavg",
                   "%interp", "timeshift",
                   "rms_timeshift", "rms_phase_front", "time_btwn_observation", "rms_sd_scalar",
                   "rms_sd_vector", "plasma_beta",
                   "alfven_mach_n", "bsn_x", "bsn_y", "bsn_z", "ae", "al", "au", "sym_d", "sym_h",
                   "asy_d", "asy_h", "pc", "magnetosonic_mach_n", "p_flux_10", "p_flux_30", "p_flux_60",
                   "e", "flow_pressure", 'by_gse', 'bz_gse', 'vx_gse', 'vy_gse', 'vz_gse', 'x_gse', 'y_gse', 'z_gse', 'bx_gse']

        maxes = {"bavg": 9999.9, "bx_gse": 9999.9, "bx_gsm": 9999.9, "by_gse": 9999.9, "bz_gse": 9999.9,
                 "by_gsm": 9999.9,
                 "bz_gsm": 9999.9, "speed": 99999.8, "vx_gse": 99999.8, "vy_gse": 99999.8, "vz_gse": 99999.8,
                 "proton_density": 999.8, "temperature": 9999998.0, "x_gse": 9999.9,
                 "y_gse": 9999.9, "z_gse": 9999.9}
