            ...
            while target_time > (datetime.today()-timedelta(days=3)):
                ...
                if len(data_one_model) > 0:
                    ...
                    for ie in range(len(data_one_model)):
                        ...
                        df_common_index = pd.DataFrame(index=pd.date_range(datetime(target_time.year, target_time.month, target_time.day), datetime(end_time.year, end_time.month, end_time.day, 23, 59, 59), freq=timedelta(minutes=1)))
