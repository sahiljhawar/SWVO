...
def test_getattr_with_invalid_variable(mock_dataset):
    """Test __getattr__ with an invalid variable."""
    with pytest.raises(AttributeError):
        _ = mock_dataset.NonExistentAttribute


def test_getattr_with_similar_variable(mock_dataset):
...
def test_computed_invv_variable(mock_dataset):
...
def test_computed_p_variable(mock_dataset):
...
def test_create_date_list_monthly(mock_dataset):
...
def test_create_date_list_daily(mock_dataset):
...
def test_invalid_cadence_raises(mock_dataset):
...
def test_invalid_folder_type_raises(mock_dataset):
...
def test_get_var_method(mock_dataset):
...
def test_all_variables_in_dir(mock_dataset):
    vars = [
        "datetime",
        "time",
        "energy_channels",
