...
def test_missing_env_var():
    with pytest.raises(ValueError, match="Necessary environment variable RT_HP_GFZ_STREAM_DIR not set!"):
        Hp30GFZ()
